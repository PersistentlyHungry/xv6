...
CFLAGS = -D SCHED_$(SCHEDFLAG) -fno-pic -static -fno-builtin -fno-strict-aliasing -Wall -MD -ggdb -m32 -Werror -fno-omit-frame-pointer
...
EXTRA=\
	...
	printf.c umalloc.c export.c wait2test.c\
